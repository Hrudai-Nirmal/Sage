...
const labels={approvals:'Pending approvals',auditEvents:'Audit events',calendarEvents:'Calendar events',calendarReminders:'Pending reminders',cases:'Active cases',documents:'Documents',driveFiles:'Cached Drive files',emails:'Email messages',emailTriage:'Pending email triage',researchRuns:'Research runs',schedules:'Active schedules',tasks:'Open tasks'};
