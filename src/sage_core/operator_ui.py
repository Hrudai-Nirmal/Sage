...
const labels={approvals:'Pending approvals',auditEvents:'Audit events',cases:'Active cases',documents:'Documents',researchRuns:'Research runs',schedules:'Active schedules',tasks:'Open tasks'};
