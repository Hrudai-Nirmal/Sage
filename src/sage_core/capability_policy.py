...
def getCapabilityPolicies() -> dict[str, CapabilityPolicy]:
    ...
    policyRows = [
        ...
        (
            "work.search",
            "Search non-archived tasks, cases, and schedules",
            "automatic read",
            True,
            "search_work_items",
        ),
        (
            "cases.details.read",
            "Read one exact case with its notes and milestones",
            "automatic read",
            True,
            "get_case_details",
        ),
        (
            "work.update",
            "Apply an explicitly requested reversible task, case, or schedule edit",
            "explicit reversible write without an approval button",
            True,
            "update_work_item",
        ),
        (
            "cases.notes.add",
            "Append an explicitly requested note to an existing case",
            "explicit reversible write without an approval button",
            False,
            "add_case_note",
        ),
        (
            "cases.milestones.add",
            "Add an explicitly requested milestone to an existing case",
            "explicit reversible write without an approval button",
            False,
            "add_case_milestone",
        ),
        (
            "cases.milestones.update",
            "Edit or complete an exact case milestone",
            "explicit reversible write without an approval button",
            True,
            "update_case_milestone",
        ),
        (
            "work.archive.propose",
            "Propose archival of an exact task, case, or schedule",
            "requires the user's approval button; permanent deletion is unavailable",
            True,
            "archive_work_item",
        ),
